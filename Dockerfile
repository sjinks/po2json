FROM --platform=${BUILDPLATFORM} tonistiigi/xx:master@sha256:d4d8350161a87057863fa6dd4c620e22f1dda019909ca5c839b3ebe9d276ce07 AS xx
...
FROM --platform=${BUILDPLATFORM} ubuntu:26.04@sha256:f3d28607ddd78734bb7f71f117f3c6706c666b8b76cbff7c9ff6e5718d46ff64 AS build-ubuntu
ARG TARGETPLATFORM
COPY --from=xx / /

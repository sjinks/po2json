...
FROM --platform=${BUILDPLATFORM} alpine:3.20.3@sha256:a8f120106f5549715aa966fd7cefaf3b7045f6414fed428684de62fec8c2ca4b AS build-alpine
ARG TARGETPLATFORM
COPY --from=xx / /
...
FROM --platform=${BUILDPLATFORM} ubuntu:24.04@sha256:dfc10878be8d8fc9c61cbff33166cb1d1fe44391539243703c72766894fa834a AS build-ubuntu
ARG TARGETPLATFORM
COPY --from=xx / /
